...
import { WelcomeOnboardingEmail } from "../workflows";

type NovuWelcomeEmailProps = WelcomeOnboardingEmail.ControlSchema & WelcomeOnboardingEmail.PayloadSchema;
...
export function renderEmail(controls: WelcomeOnboardingEmail.ControlSchema, payload: WelcomeOnboardingEmail.PayloadSchema) {
